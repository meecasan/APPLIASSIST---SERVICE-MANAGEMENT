              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={tempPersonalInfo.streetName}
                      onChange={(e) => setTempPersonalInfo({ ...tempPersonalInfo, streetName: e.target.value })}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1E2F4F] focus:border-transparent transition-all"
                      style={{ fontFamily: 'Manrope, sans-serif' }}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={tempPersonalInfo.buildingNumber}
                      onChange={(e) => setTempPersonalInfo({ ...tempPersonalInfo, buildingNumber: e.target.value })}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1E2F4F] focus:border-transparent transition-all"
                      style={{ fontFamily: 'Manrope, sans-serif' }}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setTempPersonalInfo({ ...tempPersonalInfo, zipCode: e.target.value })}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1E2F4F] focus:border-transparent transition-all"
                      style={{ fontFamily: 'Manrope, sans-serif' }}
                    />
                  </div>
