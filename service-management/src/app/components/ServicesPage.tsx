  ...
  useEffect(() => {
    const loadServices = async () => {
      try {
        ...
        // Group services by category/type and count technicians
              ...
              <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                {categories.map((category) => (
                  <button
                    ...
                    className={`px-5 py-2 rounded-full font-medium whitespace-nowrap transition-all ${selectedCategory === category.toLowerCase().replace(' ', '-')
