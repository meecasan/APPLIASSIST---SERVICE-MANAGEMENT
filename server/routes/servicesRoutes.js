...
// List services - admin, technician, store_owner, customer (with filtering options)
router.get('/', authMiddleware, role(['admin','technician','store_owner','customer']), servicesController.listServices);
...
// Public: Get services offered by a specific technician (no auth required)
const catalogController = require('../controllers/catalogController');
router.get('/technician/:technician_id', catalogController.getServicesByTechnician);
